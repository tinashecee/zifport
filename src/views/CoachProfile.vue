...
import EditCoachModal from '@/components/common/EditCoachModal.vue'
...
watch(() => route.query.edit, (edit) => {
  if (edit === '1' && coach.value) showEditModal.value = true
}, { immediate: false })

watch(coach, (c) => {
  if (c && route.query.edit === '1') showEditModal.value = true
}, { immediate: true })
</script>
